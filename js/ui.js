...
ส่วนนี่คือโค้ดที่คุณแก้มาแบ้สค้าง
...
function saveConfig() { 
    ...
    db.collection("app_settings").doc("config").set(appConfig).then(()=>{ showToast("บันทึกสำเร็จ"); closeConfig(); renderSidebar(); renderNews(); }); 
